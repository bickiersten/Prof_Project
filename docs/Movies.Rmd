...
Something that many people go off of on whether they want to see a movie or not is how other people have rated it. 
...
ggplot(movies, aes(x = factor(rating), y = gross))+
  geom_dotplot(binaxis = "y", stackdir = "up", position = "dodge", dotsize = 0.4)+
   ylim(0, 1000000000)+
  labs(
