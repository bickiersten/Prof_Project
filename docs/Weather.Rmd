...
cat("Enter Dew Point (°F): ")
dew <- as.numeric(readline())
cat("Enter Sea Level Pressure (hPa): ")
sea <- as.numeric(readline())

predicted_temp <- intercept + coef_dew * dew + coef_sea * sea

cat(sprintf("Predicted Temperature: %.2f °F\n", predicted_temp))
```
